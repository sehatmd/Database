...
CREATE TABLE `doctor_credentials` (
  `doctor_credentials_id` int(11) NOT NULL,
  ...
  PRIMARY KEY (`doctor_credentials_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(1,NULL,NULL,'admin','admin','$2a$10$V0Xaj5dXCXc8kJ2Al4CVc./QiHAAMaTuE7oFRP2sG35nI0HdUInSe',NULL,NULL),
